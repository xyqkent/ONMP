...
```
 $ sh -c "$(curl -kfsSl https://raw.githubusercontent.com/xyqkent/ONMP/master/oneclick.sh)"
```
...
# 下载软件包
wget --no-check-certificate -O /opt/onmp.zip https://github.com/xyqkent/ONMP/archive/master.zip 
